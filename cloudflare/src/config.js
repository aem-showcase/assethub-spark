...
const config = {
  ...
  // the configured customer. When running the enrichment agent for a prospect, the agent
  // auto-patches this value after a successful run. Value is the customer key, NOT the
  // logged-in viewer's company.
  DEMO_COMPANY: 'hyundai-india',

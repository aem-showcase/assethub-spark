...
const config = {
  ...
  // the configured customer. The rebrand flow patches this for each company demo after
  // copying and rewriting its scoped content.
  // after a successful run. Value is the customer key, NOT the logged-in viewer's company.
  DEMO_COMPANY: 'kirklands',
  ...
  DEMO_BASE_PATH: '/companies/kirklands',

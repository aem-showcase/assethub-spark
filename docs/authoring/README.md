# Spark Assets Content Authoring Guide

This guide helps content authors create and manage informational pages on the Spark Assets portal.

## About This Guide

Spark Assets is built on Adobe Experience Manager Edge Delivery Services (EDS) using **Document Authoring**. This guide focuses on Spark Assets-specific patterns and blocks. For general Document Authoring concepts, refer to the [Document Authoring documentation](https://docs.da.live/).

## Prerequisites

Before you begin, ensure you have:

- Access to the Spark Assets content repository in Document Authoring

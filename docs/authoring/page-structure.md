...
A typical Spark Assets page consists of:
...
|----------|---------|---------|
| `title` | Page title (browser tab, search results) | `About Spark Assets` |
...
| Metadata    |                                        |
|-------------|----------------------------------------|
| title       | Spark Assets - Digital Asset Portal       |

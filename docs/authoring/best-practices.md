...
This guide covers tips and recommendations for effective content authoring in Spark Assets.
...
- **Test on mobile** - Many users access Spark Assets on smaller screens

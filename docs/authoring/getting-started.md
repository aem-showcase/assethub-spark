...
This guide walks you through the basics of creating content for Spark Assets using Document Authoring.

## What is Document Authoring?

Document Authoring is a web-based content editing platform that lets you create and manage web pages using a familiar document-editing experience. Your documents automatically become web pages on the Spark Assets site.
...
3. The Sidekick will appear when you're working on Spark Assets content

### 2. Access Document Authoring

1. Go to [da.live](https://da.live/)
2. Sign in with your authorized account
3. Navigate to the Spark Assets content folder

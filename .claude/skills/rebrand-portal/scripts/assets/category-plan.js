 ...
 * word-for-word (via `wordSet`, singular/plural-normalized) rather than substring, so a
 * plural contract label ("Accessories") still matches singular evidence ("accessory") without

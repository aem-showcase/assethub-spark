...
function isBrandContent(node) {
  ...
  return Boolean(
    node.querySelector?.('.icon-honda-cars-india-icon')
  ...
  if (getMetadata('header') === 'no') {
    ...
    welcomeBar.innerHTML = `
      <a href="/" class="welcome-logo" aria-label="Home">
        <span class="icon icon-honda-cars-india-icon">
          <img src="/icons/honda-cars-india-icon.svg" alt="Honda Cars India" loading="eager" />
        </span>
      </a>`;

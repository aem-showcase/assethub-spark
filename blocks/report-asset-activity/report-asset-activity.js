...
// Brand-derived chart palette — built around the current brand theme (green --primary-color
// #13670B, maroon --text-color #163229) plus harmonious supporting tones, so charts
...
const BRAND_SEQUENCE = [
  '#13670B', // brand teal (primary)
  '#A35E4B', // terracotta
  '#C99A3F', // warm gold
  '#163229', // brand maroon (text-color)
  '#3D8FA3', // light teal
  '#6E7E5B', // sage
  '#8A6D3B', // bronze
  '#4F6472', // slate

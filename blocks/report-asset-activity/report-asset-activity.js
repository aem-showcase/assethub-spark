...
// Brand-derived chart palette — built around the Meta theme (blue --primary-color
// #0064E0, near-black --text-color #1C1E21) plus harmonious supporting tones, so charts
...
const BRAND_SEQUENCE = [
  '#0064E0', // brand blue (primary)
  '#0866FF', // bright blue
  '#7B8794', // slate grey
  '#1C1E21', // brand near-black (text-color)
  '#4D94EA', // light blue
  '#42B72A', // supporting green
  '#0348A6', // deep blue
  '#8CBBF2', // pale blue
];
const PALETTE = {
  download: '#0064E0', // primary blue — dominant action
  view: '#4D94EA', // light blue
  'share-link-copy': '#42B72A', // supporting green
  'dm-url-copy': '#0866FF', // bright blue
  'collection-add': '#1C1E21', // brand near-black
  internal: '#0064E0',
  external: '#4D94EA',

...
// Brand-derived chart palette — built around the Kirkland's theme (teal --primary-color
// #00253D, maroon --text-color #212322) plus harmonious supporting tones, so charts
...
const BRAND_SEQUENCE = [
  '#00253D', // brand teal (primary)
  '#A35E4B', // terracotta
  '#C99A3F', // warm gold
  '#212322', // brand maroon (text-color)
  '#3D8FA3', // light teal
  '#6E7E5B', // sage
  '#8A6D3B', // bronze
  '#4F6472', // slate

...
// Brand-derived chart palette — built around the Calm theme (teal --primary-color
// #291a3c, maroon --text-color #555be4) plus harmonious supporting tones, so charts
...
const BRAND_SEQUENCE = [
  '#291a3c', // brand teal (primary)
  '#A35E4B', // terracotta
  '#C99A3F', // warm gold
  '#555be4', // brand maroon (text-color)
  '#3D8FA3', // light teal
  '#6E7E5B', // sage
  '#8A6D3B', // bronze
  '#4F6472', // slate

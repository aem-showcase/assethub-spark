...
// Brand-derived chart palette — built around the brand theme (navy --primary-color
// #002C5F, cyan --accent-secondary #00AAD2) plus harmonious supporting tones, so charts
...
const BRAND_SEQUENCE = [
  '#002C5F', // brand navy (primary)
  '#00AAD2', // brand cyan (accent)
  '#D9822B', // amber
  '#7A8FA6', // steel
  '#4E6E5D', // sage
  '#9A6E8F', // mauve
...
const PALETTE = {
  download: '#002C5F', // primary navy — dominant action
  view: '#00AAD2', // brand cyan
  'share-link-copy': '#D9822B', // amber
  'dm-url-copy': '#7A8FA6', // steel
  'collection-add': '#4E6E5D', // sage
  internal: '#002C5F',
  external: '#00AAD2',

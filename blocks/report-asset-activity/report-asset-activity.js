...
// Brand-derived chart palette — built around the Salesforce theme (blue --primary-color
// #0176D3, navy --text-color #032D60) plus harmonious supporting tones, so charts
...
const BRAND_SEQUENCE = [
  '#0176D3', // brand blue (primary)
  '#00A1E0', // cloud blue
  '#1B96FF', // bright blue
  '#032D60', // brand navy (text-color)
  '#57A3F5', // light blue
  '#7F8DE1', // periwinkle
  '#0B827C', // teal
  '#4F6472', // slate
...
const PALETTE = {
  download: '#0176D3', // primary blue — dominant action
  view: '#00A1E0', // cloud blue
  'share-link-copy': '#1B96FF', // bright blue
  'dm-url-copy': '#57A3F5', // light blue
  'collection-add': '#032D60', // brand navy
  internal: '#0176D3',
  external: '#00A1E0',

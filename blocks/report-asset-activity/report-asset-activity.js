...
// Brand-derived chart palette — built around the Whirlpool theme (navy --primary-color
// #231F5C, gold --accent-tertiary #eeb111) plus harmonious supporting tones, so charts
// match the rest of the app instead of using a generic/Google default palette.
// Primary navy is reserved for `download` (the dominant action in this report).
const BRAND_SEQUENCE = [
  '#231F5C', // brand navy (primary)
  '#C98A0E', // deep gold
  '#eeb111', // brand gold (accent)
  '#5B5A8C', // muted blue-violet
  '#3A3576', // light navy
  '#8A6D3B', // bronze
  '#4F6472', // slate
  '#6E7E5B', // sage
...
const PALETTE = {
  download: '#231F5C', // primary navy — dominant action
  view: '#3A3576', // light navy
  'share-link-copy': '#C98A0E', // deep gold
  'dm-url-copy': '#eeb111', // brand gold
  'collection-add': '#5B5A8C', // muted blue-violet
  internal: '#231F5C',
  external: '#3A3576',

...
// #2a60b3, maroon --text-color #0d3c7a) plus harmonious supporting tones, so charts
...
const BRAND_SEQUENCE = [
  '#2a60b3', // brand teal (primary)
  '#A35E4B', // terracotta
  '#C99A3F', // warm gold
  '#0d3c7a', // brand maroon (text-color)
  '#3D8FA3', // light teal
  '#6E7E5B', // sage
  '#8A6D3B', // bronze
  '#4F6472', // slate

...
// Brand-derived chart palette — built around the Costco theme (blue --primary-color
// #005dab, black --text-color #000000) plus harmonious supporting tones, so charts
...
const PALETTE = {
  download: '#005dab', // primary blue — dominant action
  view: '#5995c8', // light blue
  'share-link-copy': '#99bedd', // pale blue
  'dm-url-copy': '#004a88', // deep blue

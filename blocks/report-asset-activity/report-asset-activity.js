...
// #001E5A, maroon --text-color #001E5A) plus harmonious supporting tones, so charts
...
const BRAND_SEQUENCE = [
  '#001E5A', // brand teal (primary)
  '#A35E4B', // terracotta
  '#C99A3F', // warm gold
  '#001E5A', // brand maroon (text-color)
  '#3D8FA3', // light teal
  '#6E7E5B', // sage
  '#8A6D3B', // bronze
  '#4F6472', // slate

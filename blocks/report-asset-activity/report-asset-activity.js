...
// Brand-derived chart palette — built around the Woolworths theme (teal --primary-color
// #008446, maroon --text-color #25251F) plus harmonious supporting tones, so charts
...
const BRAND_SEQUENCE = [
  '#008446', // brand teal (primary)
  '#A35E4B', // terracotta
  '#C99A3F', // warm gold
  '#25251F', // brand maroon (text-color)
  '#3D8FA3', // light teal
  '#6E7E5B', // sage
  '#8A6D3B', // bronze
  '#4F6472', // slate

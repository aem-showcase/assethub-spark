...
// #0968F6, maroon --text-color #191919) plus harmonious supporting tones, so charts
...
const BRAND_SEQUENCE = [
  '#0968F6', // brand teal (primary)
  '#A35E4B', // terracotta
  '#C99A3F', // warm gold
  '#191919', // brand maroon (text-color)
  '#3D8FA3', // light teal
  '#6E7E5B', // sage
  '#8A6D3B', // bronze
  '#4F6472', // slate

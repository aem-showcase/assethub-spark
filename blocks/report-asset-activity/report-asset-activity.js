...
// Brand-derived chart palette — built around the Workday theme (navy --primary-color
// #022043, blue --link-hover-color #0057AE) plus harmonious supporting tones, so charts
...
const PALETTE = {
  download: '#022043', // primary navy — dominant action
  view: '#0057AE', // brand blue
  'share-link-copy': '#0875E1', // bright blue
  'dm-url-copy': '#3D6EA3', // slate blue
  'collection-add': '#9FCFFF', // light blue
  internal: '#022043',
  external: '#0057AE',

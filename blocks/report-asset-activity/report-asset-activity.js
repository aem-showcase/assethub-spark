...
// Brand-derived chart palette — built around the Heineken theme (teal --primary-color
// #13670B, maroon --text-color #646464) plus harmonious supporting tones, so charts
...
const BRAND_SEQUENCE = [
  ...
  '#A35E4B', // terracotta
  '#C99A3F', // warm gold
  '#646464', // brand maroon (text-color)
  '#3D8FA3', // light teal
  '#6E7E5B', // sage
  '#8A6D3B', // bronze
  '#4F6472', // slate
...
const PALETTE = {
  ...
  'collection-add': '#646464', // brand maroon
  internal: '#13670B',
  external: '#3D8FA3',

...
// #008200, maroon --text-color #14231A) plus harmonious supporting tones, so charts
...
const BRAND_SEQUENCE = [
  '#008200', // brand teal (primary)
  '#A35E4B', // terracotta
  '#C99A3F', // warm gold
  '#14231A', // brand maroon (text-color)
  '#3D8FA3', // light teal
  '#6E7E5B', // sage
  '#8A6D3B', // bronze
  '#4F6472', // slate

...
// Brand-derived chart palette — built around the Calm theme (indigo --primary-color
// #555BE4, deep plum --text-color #291A3C) plus harmonious supporting tones, so charts
...
const BRAND_SEQUENCE = [
  '#555BE4', // brand indigo (primary)
  '#A35E4B', // terracotta
  '#C99A3F', // warm gold
  '#291A3C', // brand plum (text-color)
  '#3D8FA3', // light teal
  '#6E7E5B', // sage
  '#8A6D3B', // bronze
  '#4F6472', // slate

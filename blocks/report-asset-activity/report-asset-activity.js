...
// Brand-derived chart palette — built around the Honda Cars India theme (red
// --primary-color #E60121, dark neutral --text-color #2C2E3F) plus harmonious
// supporting tones, so charts match the rest of the app instead of using a
// generic/Google default palette.
// Primary red is reserved for `download` (the dominant action in this report).
const BRAND_SEQUENCE = [
  '#E60121', // brand red (primary)
  '#A35E4B', // terracotta
  '#C99A3F', // warm gold
  '#2C2E3F', // brand dark neutral (text-color)
  '#3D8FA3', // slate blue
  '#6E7E5B', // sage
  '#8A6D3B', // bronze
  '#4F6472', // slate
...
const PALETTE = {
  download: '#E60121', // primary red — dominant action
  view: '#3D8FA3', // slate blue
  'share-link-copy': '#C99A3F', // warm gold
  'dm-url-copy': '#A35E4B', // terracotta
  'collection-add': '#2C2E3F', // brand dark neutral
  internal: '#E60121',
  external: '#3D8FA3',

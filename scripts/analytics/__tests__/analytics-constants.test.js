...
describe('analytics-constants', () => {
  ...
  describe('ROLE_COLORS', () => {
    it('has colors for all known roles and Other', () => {
      expect(ROLE_COLORS.Associate).toBe('#0064E0');
      expect(ROLE_COLORS.Agency).toBe('#7B8794');
      expect(ROLE_COLORS.Partner).toBe('#1C1E21');
  ...
  describe('getRoleColor', () => {
    it('returns correct colors for known roles', () => {
      expect(getRoleColor('Associate')).toBe('#0064E0');
      expect(getRoleColor('Agency')).toBe('#7B8794');
      expect(getRoleColor('Partner')).toBe('#1C1E21');

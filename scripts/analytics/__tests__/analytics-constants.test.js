...
describe('analytics-constants', () => {
  ...
  describe('ROLE_COLORS', () => {
    it('has colors for all known roles and Other', () => {
      expect(ROLE_COLORS.Associate).toBe('#0071E3');
      expect(ROLE_COLORS.Agency).toBe('#86868B');
      expect(ROLE_COLORS.Partner).toBe('#1D1D1F');
  ...
  describe('getRoleColor', () => {
    it('returns correct colors for known roles', () => {
      expect(getRoleColor('Associate')).toBe('#0071E3');
      expect(getRoleColor('Agency')).toBe('#86868B');
      expect(getRoleColor('Partner')).toBe('#1D1D1F');

...
describe('analytics-constants', () => {
  ...
  describe('ROLE_COLORS', () => {
    it('has colors for all known roles and Other', () => {
      expect(ROLE_COLORS.Associate).toBe('#CC0000');
      expect(ROLE_COLORS.Agency).toBe('#EDE7CF');
  ...
  describe('getRoleColor', () => {
    it('returns correct colors for known roles', () => {
      expect(getRoleColor('Associate')).toBe('#CC0000');
      expect(getRoleColor('Agency')).toBe('#EDE7CF');

...
describe('analytics-constants', () => {
  ...
  describe('ROLE_COLORS', () => {
    it('has colors for all known roles and Other', () => {
      expect(ROLE_COLORS.Associate).toBe('#FF0000');
      expect(ROLE_COLORS.Agency).toBe('#FFE336');
  ...
  describe('getRoleColor', () => {
    it('returns correct colors for known roles', () => {
      expect(getRoleColor('Associate')).toBe('#FF0000');
      expect(getRoleColor('Agency')).toBe('#FFE336');

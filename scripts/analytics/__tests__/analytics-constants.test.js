...
describe('analytics-constants', () => {
  ...
  describe('ROLE_COLORS', () => {
    it('has colors for all known roles and Other', () => {
      expect(ROLE_COLORS.Associate).toBe('#E60121');
      expect(ROLE_COLORS.Agency).toBe('#141517');
      expect(ROLE_COLORS.Partner).toBe('#2C2E3F');
  ...
  describe('getRoleColor', () => {
    it('returns correct colors for known roles', () => {
      expect(getRoleColor('Associate')).toBe('#E60121');
      expect(getRoleColor('Agency')).toBe('#141517');
      expect(getRoleColor('Partner')).toBe('#2C2E3F');

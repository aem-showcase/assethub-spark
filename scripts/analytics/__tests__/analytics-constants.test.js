...
describe('analytics-constants', () => {
  ...
  describe('ROLE_COLORS', () => {
    it('has colors for all known roles and Other', () => {
      expect(ROLE_COLORS.Associate).toBe('#022043');
      expect(ROLE_COLORS.Agency).toBe('#9FCFFF');
      expect(ROLE_COLORS.Partner).toBe('#0057AE');
  ...
  describe('getRoleColor', () => {
    it('returns correct colors for known roles', () => {
      expect(getRoleColor('Associate')).toBe('#022043');
      expect(getRoleColor('Agency')).toBe('#9FCFFF');
      expect(getRoleColor('Partner')).toBe('#0057AE');

...
describe('analytics-constants', () => {
  ...
  describe('ROLE_COLORS', () => {
    it('has colors for all known roles and Other', () => {
      expect(ROLE_COLORS.Associate).toBe('#008200');
      expect(ROLE_COLORS.Agency).toBe('#D4AF37');
      expect(ROLE_COLORS.Partner).toBe('#14231A');
  ...
  describe('getRoleColor', () => {
    it('returns correct colors for known roles', () => {
      expect(getRoleColor('Associate')).toBe('#008200');
      expect(getRoleColor('Agency')).toBe('#D4AF37');
      expect(getRoleColor('Partner')).toBe('#14231A');

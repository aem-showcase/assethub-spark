...
describe('analytics-constants', () => {
  ...
  describe('ROLE_COLORS', () => {
    it('has colors for all known roles and Other', () => {
      expect(ROLE_COLORS.Associate).toBe('#005DAB');
      expect(ROLE_COLORS.Agency).toBe('#CC9900');
      expect(ROLE_COLORS.Partner).toBe('#E51937');
  ...
  describe('getRoleColor', () => {
    it('returns correct colors for known roles', () => {
      expect(getRoleColor('Associate')).toBe('#005DAB');
      expect(getRoleColor('Agency')).toBe('#CC9900');
      expect(getRoleColor('Partner')).toBe('#E51937');

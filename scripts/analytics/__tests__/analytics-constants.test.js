...
describe('analytics-constants', () => {
  ...
  describe('ROLE_COLORS', () => {
    it('has colors for all known roles and Other', () => {
      expect(ROLE_COLORS.Associate).toBe('#555BE4');
      expect(ROLE_COLORS.Agency).toBe('#6C9CE6');
      expect(ROLE_COLORS.Partner).toBe('#291A3C');
  ...
  describe('getRoleColor', () => {
    it('returns correct colors for known roles', () => {
      expect(getRoleColor('Associate')).toBe('#555BE4');
      expect(getRoleColor('Agency')).toBe('#6C9CE6');
      expect(getRoleColor('Partner')).toBe('#291A3C');

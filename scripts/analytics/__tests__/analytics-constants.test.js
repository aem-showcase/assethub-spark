...
describe('analytics-constants', () => {
  ...
  describe('ROLE_COLORS', () => {
    it('has colors for all known roles and Other', () => {
      expect(ROLE_COLORS.Associate).toBe('#0968F6');
      expect(ROLE_COLORS.Agency).toBe('#FFBD14');
  ...
  describe('getRoleColor', () => {
    it('returns correct colors for known roles', () => {
      expect(getRoleColor('Associate')).toBe('#0968F6');
      expect(getRoleColor('Agency')).toBe('#FFBD14');

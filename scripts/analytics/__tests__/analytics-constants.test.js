...
describe('analytics-constants', () => {
  ...
  describe('ROLE_COLORS', () => {
    it('has colors for all known roles and Other', () => {
      expect(ROLE_COLORS.Associate).toBe('#2874F0');
      expect(ROLE_COLORS.Agency).toBe('#FFC200');
      expect(ROLE_COLORS.Partner).toBe('#212121');
  ...
  describe('getRoleColor', () => {
    it('returns correct colors for known roles', () => {
      expect(getRoleColor('Associate')).toBe('#2874F0');
      expect(getRoleColor('Agency')).toBe('#FFC200');
      expect(getRoleColor('Partner')).toBe('#212121');

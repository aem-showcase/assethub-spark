...
describe('analytics-constants', () => {
  ...
  describe('ROLE_COLORS', () => {
    it('has colors for all known roles and Other', () => {
      expect(ROLE_COLORS.Associate).toBe('#291a3c');
      expect(ROLE_COLORS.Agency).toBe('#2f80d0');
      expect(ROLE_COLORS.Partner).toBe('#555be4');
  ...
  describe('getRoleColor', () => {
    it('returns correct colors for known roles', () => {
      expect(getRoleColor('Associate')).toBe('#291a3c');
      expect(getRoleColor('Agency')).toBe('#2f80d0');
      expect(getRoleColor('Partner')).toBe('#555be4');

...
describe('analytics-constants', () => {
  ...
  describe('ROLE_COLORS', () => {
    it('has colors for all known roles and Other', () => {
      expect(ROLE_COLORS.Associate).toBe('#00253D');
      expect(ROLE_COLORS.Agency).toBe('#828081');
      expect(ROLE_COLORS.Partner).toBe('#212322');
  ...
  describe('getRoleColor', () => {
    it('returns correct colors for known roles', () => {
      expect(getRoleColor('Associate')).toBe('#00253D');
      expect(getRoleColor('Agency')).toBe('#828081');
      expect(getRoleColor('Partner')).toBe('#212322');

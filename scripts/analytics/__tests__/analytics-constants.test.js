...
describe('analytics-constants', () => {
  ...
  describe('ROLE_COLORS', () => {
    it('has colors for all known roles and Other', () => {
      expect(ROLE_COLORS.Associate).toBe('#008446');
      expect(ROLE_COLORS.Agency).toBe('#FFC220');
      expect(ROLE_COLORS.Partner).toBe('#25251F');
  ...
  describe('getRoleColor', () => {
    it('returns correct colors for known roles', () => {
      expect(getRoleColor('Associate')).toBe('#008446');
      expect(getRoleColor('Agency')).toBe('#FFC220');
      expect(getRoleColor('Partner')).toBe('#25251F');

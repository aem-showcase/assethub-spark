...
describe('analytics-constants', () => {
  ...
  describe('ROLE_COLORS', () => {
    it('has colors for all known roles and Other', () => {
      expect(ROLE_COLORS.Associate).toBe('#001E5A');
      expect(ROLE_COLORS.Agency).toBe('#FCC200');
      expect(ROLE_COLORS.Partner).toBe('#001E5A');
  ...
  describe('getRoleColor', () => {
    it('returns correct colors for known roles', () => {
      expect(getRoleColor('Associate')).toBe('#001E5A');
      expect(getRoleColor('Agency')).toBe('#FCC200');
      expect(getRoleColor('Partner')).toBe('#001E5A');

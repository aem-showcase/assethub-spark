...
describe('analytics-constants', () => {
  ...
  describe('ROLE_COLORS', () => {
    it('has colors for all known roles and Other', () => {
      expect(ROLE_COLORS.Associate).toBe('#2A60B3');
      expect(ROLE_COLORS.Agency).toBe('#F4B942');
      expect(ROLE_COLORS.Partner).toBe('#1A1A1A');
  ...
  describe('getRoleColor', () => {
    it('returns correct colors for known roles', () => {
      expect(getRoleColor('Associate')).toBe('#2A60B3');
      expect(getRoleColor('Agency')).toBe('#F4B942');
      expect(getRoleColor('Partner')).toBe('#1A1A1A');

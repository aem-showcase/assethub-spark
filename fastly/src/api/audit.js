// Asset-activity audit API (D1). Ported from cloudflare/src/api/audit.js — only the two
// repo-root scripts/ import paths change to the ported copies under fastly/src/. The
// `env.AUDIT_EVENTS` binding is the D1-over-HTTP client (platform/d1-http.js).
...
import {
  ...
  defaultFrom,
} from '../audit/asset-audit-constants.js';
